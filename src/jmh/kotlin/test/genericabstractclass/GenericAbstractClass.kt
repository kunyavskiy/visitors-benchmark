package test.genericabstractclass
import org.openjdk.jmh.annotations.*
import java.util.concurrent.TimeUnit
import kotlin.random.Random

abstract class Visitor<T> {
    open fun visit(node: TreeNode, data: T) = node.acceptChildren(this, data)
    open fun visit0(node: Leaf, data: T) = visit(node, data)
    open fun visit1(node: OneChildNode, data: T) = visit(node, data)
    open fun visit2(node: TwoChildNode, data: T) = visit(node, data)
    open fun visit3(node: ThreeChildNode, data: T) = visit(node, data)
    open fun visit4(node: FourChildNode, data: T) = visit(node, data)
}

abstract class VisitorVoid: Visitor<Nothing?>() {
    open fun visit(node: TreeNode) = node.acceptChildren(this, null)
    open fun visit0(node: Leaf) = visit(node)
    open fun visit1(node: OneChildNode) = visit(node)
    open fun visit2(node: TwoChildNode) = visit(node)
    open fun visit3(node: ThreeChildNode) = visit(node)
    open fun visit4(node: FourChildNode) = visit(node)
    final override fun visit(node: TreeNode, data: Nothing?) = visit(node)
    final override fun visit0(node: Leaf, data: Nothing?) = visit0(node)
    final override fun visit1(node: OneChildNode, data: Nothing?) = visit1(node)
    final override fun visit2(node: TwoChildNode, data: Nothing?) = visit2(node)
    final override fun visit3(node: ThreeChildNode, data: Nothing?) = visit3(node)
    final override fun visit4(node: FourChildNode, data: Nothing?) = visit4(node)
}
...
open class TestGenericAbstractClass {
